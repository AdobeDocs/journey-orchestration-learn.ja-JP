...
+ [遍歴の検証と公開](/help/validate-and-publish-a-journey.md)
+ [レポートツールを使用したジャーニーの分析](/help/analyze-a-journey-via-reporting-tools.md)
+ [Adobe Experience Platformへのレポート遍歴ステップイベント](/help/reporting-step-events-to-adobe-experience-platform.md)
+ [Journey Orchestrationに関するヘルプの検索方法](/help/how-to-find-help-with-journey-orchestration.md)
